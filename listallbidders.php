...
<tr><th>Bidder Number</th><th>Bidder Name</th><th>Address</th><th>Cellphone Number</th><th>Home Number</th><th>Email</th><th>Update Bidder Information</th><th>Delete Bidder</th></tr>
<?php
...
//SELECT the columns I need from the recipe table
	$SQL = "SELECT Bidder.BidderID , Bidder.Name , Bidder.Address, Bidder.CellNumber, Bidder.HomeNumber, Bidder.Email";
	$SQL .= " FROM Bidder";
	...
	do {
		...
		echo "<td>";
		?>
		<form method="post" action="bidderinfoupdate.php">
		<button class ="button button2"> Update Bidder Information 
		...
		echo "<td>";
		?>
		<form method ="post" action = "deletebidder.php">
		<input type = "hidden" name="BidderID" value="<?php echo $result['BidderID']; ?>">
		<button class ="button button1"> Delete Bidder
		</button>
		</form>
		<?php
		echo "</td>";
